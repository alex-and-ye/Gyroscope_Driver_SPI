...
#define A3G4250D_SPI &hspi1 // SPI interface
...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	void A3G4250D_WriteReg(uint8_t reg, uint8_t data) {
	    HAL_GPIO_WritePin(A3G4250D_CS_GPIO_PORT, A3G4250D_CS_PIN, GPIO_PIN_RESET);
	    uint8_t txData[2] = {reg, data};
	    HAL_SPI_Transmit(A3G4250D_SPI, txData, 2, 100);
	    HAL_GPIO_WritePin(A3G4250D_CS_GPIO_PORT, A3G4250D_CS_PIN, GPIO_PIN_SET);
	}
	...
	uint8_t A3G4250D_ReadReg(uint8_t reg) {
	    ...
	    uint8_t rxData;
	    HAL_SPI_TransmitReceive(A3G4250D_SPI, &txData, &rxData, 1, 100);
	    HAL_GPIO_WritePin(A3G4250D_CS_GPIO_PORT, A3G4250D_CS_PIN, GPIO_PIN_SET);
	    return rxData;
	}

	// Function to read gyroscope data
	void A3G4250D_ReadGyro(int16_t* pData) {
	    uint8_t tempL, tempH;
	    tempL = A3G4250D_ReadReg(A3G4250D_OUT_X_L);
	    tempH = A3G4250D_ReadReg(A3G4250D_OUT_X_H);
	    pData[0] = (tempH << 8) | tempL;
	    tempL = A3G4250D_ReadReg(A3G4250D_OUT_Y_L);
	    tempH = A3G4250D_ReadReg(A3G4250D_OUT_Y_H);
	    pData[1] = (tempH << 8) | tempL;
	    tempL = A3G4250D_ReadReg(A3G4250D_OUT_Z_L);
	    tempH = A3G4250D_ReadReg(A3G4250D_OUT_Z_H);
	...
	void A3G4250D_Init(void) {
	    ...
	    GPIO_InitStruct.Pin = A3G4250D_CS_PIN;
	    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	    GPIO_InitStruct.Pull = GPIO_NOPULL;
	    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
	    HAL_GPIO_Init(A3G4250D_CS_GPIO_PORT, &GPIO_InitStruct);
	    // Set CS pin high
	    HAL_GPIO_WritePin(A3G4250D_CS_GPIO_PORT, A3G4250D_CS_PIN, GPIO_PIN_SET);
